...
class TestComputeInvestmentBalances:
    def test_basic_investment(self):
        amount, new_unalloc, new_vehicle = compute_investment_balances(
            Decimal("10000.0000"),
            Decimal("5000.0000"),
            Decimal("30.0000"),
            Decimal("100.0000"),
        )
        assert amount == Decimal("3000.0000")
    ...
    def test_full_balance_investment(self):
        ...
        assert amount == Decimal("5000.0000")
    ...
    def test_fractional_shares(self):
        ...
        assert amount == Decimal("1500.0000")
